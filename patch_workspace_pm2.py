...
# Inject after `export default function WorkspacePm() {`
component_start_pattern = r"(export default function WorkspacePm\(\) \{)"
...
state_vars = """
    ...
    const isAuthorized = true; // For now allow everyone, or add specific staff
