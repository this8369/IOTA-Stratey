...
async function run() {
    // Delete existing 'new' phase for '421'
    await supabase.from('iota_capital_stack').delete().eq('vehicle_name', '421').eq('phase', 'new');

    const data = [
        // A종
        { vehicle_name: '421', phase: 'new', tranche_type: 'Equity', tranche_name: 'A종 수익증권', institution_name: '한중건설㈜', amount_krw_100m: 130, counterparty_id: 'CP-0436' },
        ...
        { vehicle_name: '421', phase: 'new', tranche_type: 'Equity', tranche_name: 'A종 수익증권', institution_name: '구봉산업㈜', amount_krw_100m: 100, counterparty_id: 'CP-0436' },
        ...
        { vehicle_name: '421', phase: 'new', tranche_type: 'Equity', tranche_name: 'B종 수익증권', institution_name: '주식회사 안다자산운용', amount_krw_100m: 15, counterparty_id: 'CP-0436' },
