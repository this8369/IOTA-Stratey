            ...
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full max-w-[1100px] mt-12 mb-16 relative">
                    ...
                    <div className="absolute top-1/2 left-[15%] right-[15%] h-[4px] bg-gray-200 z-0 -translate-y-1/2 overflow-hidden">
                        <div className={`h-full bg-[#1e3a8a] transition-all duration-[1700ms] ease-in-out ${step >= 4 ? 'translate-x-0 w-full opacity-100' : '-translate-x-full w-0 opacity-0'}`}></div>
                    </div>

                    <div className="flex w-full justify-between items-center relative z-10 px-[56px]">
                        {/* Node 1: Raw Data */}
                        <div className={`w-[260px] bg-white border-4 border-[#1e3a8a] rounded-none p-5 shadow-sm transition-all duration-[600ms] ${step >= 3 ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`}>
                        ...
                        {/* Node 2: AI Core */}
                        <div className={`flex flex-col items-center transition-all duration-[850ms] ${step >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        ...
                        <div className={`w-[260px] bg-white border-4 border-[#1e3a8a] rounded-none p-5 shadow-sm transition-all duration-[850ms] ${step >= 5 ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`}>
