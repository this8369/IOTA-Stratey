    ...
    return (
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full max-w-[1200px] mt-[20px] mb-[40px] flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 transition-all duration-[1000ms]">
                    
                    {/* Past (IMF) */}
                    <div className={`flex-1 w-full bg-gray-50 border-[6px] border-gray-300 p-10 flex flex-col items-center text-center relative grayscale opacity-70 transition-all duration-1000 ${step >= 2 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
                    ...
                    {/* Arrow / Reversal icon */}
                    <div className={`hidden md:flex flex-col items-center justify-center transition-all duration-1000 delay-150 ${step >= 2 ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}>
