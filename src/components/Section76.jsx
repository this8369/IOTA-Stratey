    ...
    return (
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full max-w-[1200px] mt-[20px] mb-[40px] flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 transition-all duration-[850ms]">
                    
                    {/* Past (IMF) */}
                    <div className={`flex-1 w-full bg-gray-50 border-[6px] border-gray-300 p-10 flex flex-col items-center text-center relative grayscale opacity-70 transition-all duration-[850ms] ${step >= 2 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
                    ...
                    {/* Arrow / Reversal icon */}
                    <div className={`hidden md:flex flex-col items-center justify-center transition-all duration-[850ms] delay-[130ms] ${step >= 2 ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}>
                    ...
                    <div className={`flex-1 w-full bg-white border-[6px] border-[#1e3a8a] p-10 flex flex-col items-center text-center shadow-2xl relative transition-all duration-[850ms] delay-[255ms] ${step >= 2 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
                ...
                {/* Bottom Text */}
                <div className={`mt-[10px] max-w-[1100px] text-[16px] md:text-[20px] leading-[1.5] font-bold text-gray-700 break-keep text-center transition-all duration-[765ms] ease-out ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
