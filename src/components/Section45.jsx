            ...
            <div className="w-full max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
                ...
                <div className={`flex-1 transition-all duration-[900ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${step >= 1 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
                    ...
                    <h2 className="text-[32px] md:text-[46px] lg:text-[52px] font-extrabold leading-[calc(1.3em-6px)] text-[#1d1d1f] break-keep tracking-[-0.02em]">
                        "동아시아 스위스" 모델 안착 및<br/>주력 산업 슈퍼사이클 동시 도래
                    </h2>
                </div>

                {/* Right Side: Stats & Assumptions (Sharp Box, Large Text) */}
                <div className={`flex-1 w-full bg-[#f8fbff] rounded-none p-8 md:p-12 border border-blue-200 transition-all duration-[1000ms] ease-out ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                    <div className="space-y-8">
                        <div>
                            <p className="text-blue-500 text-[14px] md:text-[15px] font-bold mb-2 uppercase">2030년 예상 GDP</p>
                        ...
                        <div>
                            <p className="text-blue-500 text-[14px] md:text-[15px] font-bold mb-2 uppercase">3조 달러 도달 시점</p>
                            <p className="text-[32px] md:text-[40px] font-bold text-[#0055ff] tracking-tight">2034 ~ 2035년</p>
                        </div>
                        <div className="w-full h-px bg-blue-100"></div>
                        <div>
                            <p className="text-blue-500 text-[14px] md:text-[15px] font-bold mb-4 uppercase">핵심 전제</p>
                            <ul className="text-gray-800 space-y-4 text-[17px] md:text-[19px] break-keep leading-relaxed font-bold">
