            ...
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center relative z-10">
                ...
                <div className="w-full max-w-[1100px] flex flex-col md:flex-row items-center justify-center gap-6 mb-12">
                    ...
                    <div className="flex-1 w-full flex items-end justify-between h-[250px] md:h-[300px] border-b-2 border-gray-300 relative">
                        ...
                        {/* 2030 */}
                        <div className={`relative flex flex-col items-center justify-end h-full w-[30%] transition-all duration-[600ms] ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                        ...
                        {/* 2035 */}
                        <div className={`relative flex flex-col items-center justify-end h-full w-[30%] transition-all duration-[600ms] delay-[170ms] ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                        ...
                        {/* 2040 */}
                        <div className={`relative flex flex-col items-center justify-end h-full w-[30%] transition-all duration-[600ms] delay-400 ${step >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                    ...
                    <div className={`w-full md:w-[350px] bg-gray-50 border border-gray-200 p-8 rounded-2xl shadow-lg transition-all duration-[850ms] ${step >= 5 ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
                ...
                {/* Bottom Thesis Text */}
                <div className={`max-w-[1100px] bg-gray-50 border border-gray-200 p-6 rounded-xl shadow-sm transition-all duration-[600ms] ${step >= 5 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
