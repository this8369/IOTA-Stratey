        ...
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center relative z-10">
                ...
                <div className="w-full max-w-[1100px] flex flex-col md:flex-row items-center justify-center gap-6 mb-12">
                    ...
                    <div className={`w-full md:w-[350px] bg-gray-50 border border-gray-200 p-8 rounded-2xl shadow-lg transition-all duration-1000 ${step >= 5 ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
                ...
                {/* Bottom Thesis Text */}
                <div className={`max-w-[1100px] bg-gray-50 border border-gray-200 p-6 rounded-xl shadow-sm transition-all duration-700 ${step >= 5 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
