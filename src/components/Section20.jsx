        ...
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="relative w-full max-w-[900px] -mt-[8px] h-[360px] flex items-center justify-center z-10 gap-10">
                    ...
                    {/* The Void (2007) */}
                    <div className={`relative flex flex-col items-center justify-center w-[200px] h-[200px] rounded-full border-4 border-dashed border-gray-300 transition-all duration-[850ms] ${step >= 2 ? 'opacity-100' : 'opacity-0 -translate-x-10'}`}>
                    ...
                    {/* Arrow */}
                    <div className={`flex items-center transition-all duration-[850ms] ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    {/* The Success (Present) */}
                    <div className={`relative flex flex-col items-center justify-center w-[260px] h-[260px] rounded-full bg-gradient-to-br from-[#0ea5e9] to-[#0369a1] shadow-2xl border-4 border-white transition-all duration-[850ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] ${step >= 4 ? 'opacity-100 scale-100' : 'opacity-0 scale-50 translate-x-10'}`}>
