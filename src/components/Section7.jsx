...
export default function Section7({ isActive }) {
 ...
 const t3 = setTimeout(() => setStep(3), 1350); // Two models side-by-side
 const t4 = setTimeout(() => setStep(4), 1980); // Bottom Content
 ...
 {/* Mori Building Box */}
 <div className={`w-full md:w-1/2 bg-white border-[3px] border-[#e0e0e0] p-10 flex flex-col items-center transition-all duration-[900ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${step >= 3 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
 ...
 {/* IOTA Box */}
 <div className={`w-full md:w-1/2 bg-[#1e3a8a] border-[3px] border-[#1e3a8a] p-10 flex flex-col items-center transition-all duration-[900ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${step >= 3 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
