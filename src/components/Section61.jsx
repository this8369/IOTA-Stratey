    ...
    return (
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full max-w-[1000px] mt-[34px] mb-[40px] flex flex-col transition-all duration-[850ms]">
                    
                    <div className={`text-[20px] font-bold text-gray-500 mb-[10px] transition-all duration-[850ms] ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        {lang === 'kr' ? '잠재성장률 하방 압력을 방어하기 위한 2대 핵심 전략' : '2 Core Strategies to Defend Downward Pressure on Potential Growth'}
                    </div>

                    <div className="flex flex-col md:flex-row w-full gap-6">
                        {/* Pillar 1 */}
                        <div className={`flex-1 bg-white shadow-xl border-t-[8px] border-indigo-600 px-10 py-8 flex flex-col items-center justify-center transition-all duration-[850ms] delay-100 ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                        ...
                        {/* Pillar 2 */}
                        <div className={`flex-1 bg-white shadow-xl border-t-[8px] border-purple-600 px-10 py-8 flex flex-col items-center justify-center transition-all duration-[850ms] delay-[255ms] ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                            <div className="flex items-center gap-3 mb-4">
