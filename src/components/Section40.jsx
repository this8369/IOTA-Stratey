...
export default function Section40({ isActive }) {
    ...
    useEffect(() => {
        ...
        const timers = [
            ...
            setTimeout(() => setStep(3), 1530),
            setTimeout(() => setStep(4), 2210),
            setTimeout(() => setStep(5), 2720)
        ];
        ...
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="relative w-full max-w-[1000px] mt-[60px] mb-[40px] flex flex-col md:flex-row items-stretch justify-center z-10 gap-12">
                    ...
                    <div className={`relative flex flex-col justify-center items-center bg-white border border-gray-200 rounded-[30px] p-8 shadow-xl transition-all duration-[850ms] w-[450px] ${step >= 2 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            ...
                            <div className={`flex items-center justify-center transition-all duration-[850ms] delay-[255ms] ${step >= 3 ? 'opacity-100 h-16' : 'opacity-0 h-0 overflow-hidden'}`}>
                                <div className="flex flex-col items-center">
                            ...
                            <div className={`flex flex-col items-center transition-all duration-[850ms] delay-[425ms] ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    {/* Arrow / Connection */}
                    <div className={`self-center text-[40px] font-black text-gray-300 transition-all duration-[850ms] ${step >= 4 ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}>
                        →
                    </div>

                    {/* IOTA Inheritance Box (Right Box) */}
                    <div className={`relative flex flex-col items-center justify-center bg-gradient-to-br from-indigo-900 to-blue-900 border border-blue-700 rounded-[30px] p-8 shadow-2xl transition-all duration-[850ms] w-[450px] text-white ${step >= 4 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
