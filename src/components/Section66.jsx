    ...
    return (
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full max-w-[1100px] mt-[50px] mb-[40px] flex flex-col transition-all duration-[850ms]">
                    
                    <div className={`flex w-full justify-center transition-all duration-[850ms] ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <div className="flex flex-col md:flex-row w-full items-stretch gap-6 mt-6">
                        {/* Losers */}
                        <div className={`flex-1 border-[4px] border-gray-300 bg-gray-50 py-4 px-10 flex flex-col items-center text-center transition-all duration-[850ms] delay-100 ${step >= 2 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
                        ...
                        {/* Winners (Shield) */}
                        <div className={`flex-1 border-[6px] border-[#1d1d1f] bg-white py-4 px-10 flex flex-col items-center text-center shadow-2xl relative transition-all duration-[850ms] delay-[255ms] ${step >= 2 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
