    ...
    return (
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                {/* Custom Infographic */}
                <div className="w-full max-w-[1000px] mt-[20px] mb-[20px] flex flex-col items-center transition-all duration-[850ms]">
                    
                    <div className={`w-full bg-[#1d1d1f] text-white py-4 px-6 shadow-2xl relative z-20 transition-all duration-[850ms] delay-100 ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <div className={`w-[90%] bg-white border-[6px] border-[#1d1d1f] py-4 px-8 shadow-lg relative z-10 -mt-2 transition-all duration-[850ms] delay-[255ms] ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <div className={`w-[80%] bg-blue-600 text-white p-6 shadow-md relative z-0 -mt-2 transition-all duration-[850ms] delay-[425ms] ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                {/* Bottom Text */}
                <div className={`mt-[10px] max-w-[1100px] text-[16px] md:text-[20px] leading-[1.5] font-bold text-[#1d1d1f] break-keep text-center transition-all duration-[765ms] ease-out ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
