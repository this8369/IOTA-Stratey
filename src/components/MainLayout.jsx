...
export default function MainLayout({ isNavOpen }) {
    const slidesLength = 34; // known length
 ...
 return 0;
    ...
    const slideAnimationTimes = [1500, 3000, 3600, 4200, 2600, 4200, 2500, 3500, 3000, 3000, 3500, 3500, 3500, 3000, 3500, 3500, 3500, 3500, 3500, 3500, 3500, 3500, 3500, 3500, 3000, 3500, 3500, 3500, 1500, 3500, 3500, 3500, 3500, 3500];
