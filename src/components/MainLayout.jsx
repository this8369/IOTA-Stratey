...
export default function MainLayout({ isNavOpen, setIsNavOpen, onNavigate }) {
    const slidesLength = 137; // updated to reflect total slides (index 0 to 136)
