...
export default function MainLayout({ isNavOpen, setIsNavOpen, onNavigate }) {
    const slidesLength = 138; // updated to reflect total slides (index 0 to 137)
