...
export default function Section84({ isActive }) {
    ...
    useEffect(() => {
        ...
        const timers = [
            ...
            setTimeout(() => setStep(2), 800),  // 2026 Box
            setTimeout(() => setStep(3), 1500), // Arrow
            setTimeout(() => setStep(4), 2200), // 2040 Box
            setTimeout(() => setStep(5), 2900)  // Bottom Text
        ];
        ...
        <section className="section w-full h-full bg-white flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full max-w-[1000px] flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 mb-16 relative">
                    ...
                    <div className={`hidden md:flex flex-col items-center justify-center transition-all duration-[1200ms] ease-out ${step >= 3 ? 'opacity-100 w-[200px]' : 'opacity-0 w-0'}`}>
                    ...
                    {/* Mobile Arrow */}
                    <div className={`md:hidden flex flex-col items-center justify-center my-4 transition-all duration-700 ${step >= 3 ? 'opacity-100 h-auto' : 'opacity-0 h-0'}`}>
