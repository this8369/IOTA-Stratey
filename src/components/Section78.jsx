        ...
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="flex flex-col md:flex-row items-end justify-center gap-4 w-full max-w-[1000px] h-[280px] md:h-[320px] relative border-b-[3px] border-[#1e3a8a] mb-8">
                    ...
                    {/* Step 1: 2030 */}
                    <div className={`flex-1 w-full flex flex-col items-center justify-end relative transition-all duration-[600ms] ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                    ...
                    {/* Step 2: 2035 */}
                    <div className={`flex-1 w-full flex flex-col items-center justify-end relative transition-all duration-[600ms] delay-[170ms] ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                    ...
                    {/* Step 3: 2040 */}
                    <div className={`flex-1 w-full flex flex-col items-center justify-end relative transition-all duration-[600ms] delay-400 ${step >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                ...
                {/* Bottom Thesis Text */}
                <div className={`max-w-[1000px] bg-indigo-50 border border-indigo-100 p-6 rounded-xl shadow-sm transition-all duration-[600ms] ${step >= 5 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
