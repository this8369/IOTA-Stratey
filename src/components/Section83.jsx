...
export default function Section83({ isActive }) {
    ...
    useEffect(() => {
        ...
        const timers = [
            ...
            setTimeout(() => setStep(3), 1200), // HK
            setTimeout(() => setStep(4), 1400), // London
            setTimeout(() => setStep(5), 1600), // Tokyo
            setTimeout(() => setStep(6), 1800), // NY
            setTimeout(() => setStep(7), 2000), // SG
            setTimeout(() => setStep(8), 2400), // Seoul
            setTimeout(() => setStep(9), 3000)  // Bottom Text
        ];
                ...
                <div className="w-full max-w-[1000px] flex flex-col gap-2 mb-10 relative">
                    ...
                    <div className="flex flex-col gap-3 border-l-[3px] border-gray-300 pl-4 pt-0 pb-2">
                        ...
                        <div className="flex items-center w-full">
                            <div className={`w-[20%] text-left text-[16px] md:text-[20px] font-bold text-gray-700 transition-all duration-500 ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
                        ...
                        {/* 2. London */}
                        <div className="flex items-center w-full">
                            <div className={`w-[20%] text-left text-[16px] md:text-[20px] font-bold text-gray-700 transition-all duration-500 ${step >= 4 ? 'opacity-100' : 'opacity-0'}`}>
                        ...
                        {/* 3. Tokyo */}
                        <div className="flex items-center w-full">
                            <div className={`w-[20%] text-left text-[16px] md:text-[20px] font-bold text-gray-700 transition-all duration-500 ${step >= 5 ? 'opacity-100' : 'opacity-0'}`}>
                        ...
                        {/* 4. New York */}
                        <div className="flex items-center w-full">
                            <div className={`w-[20%] text-left text-[16px] md:text-[20px] font-bold text-gray-700 transition-all duration-500 ${step >= 6 ? 'opacity-100' : 'opacity-0'}`}>
                        ...
                        {/* 5. Singapore */}
                        <div className="flex items-center w-full">
                            <div className={`w-[20%] text-left text-[16px] md:text-[20px] font-bold text-gray-700 transition-all duration-500 ${step >= 7 ? 'opacity-100' : 'opacity-0'}`}>
                        ...
                        <div className="flex items-center w-full mt-2">
                            <div className={`w-[20%] text-left text-[18px] md:text-[22px] font-black text-[#1e3a8a] transition-all duration-500 ${step >= 8 ? 'opacity-100' : 'opacity-0'}`}>
