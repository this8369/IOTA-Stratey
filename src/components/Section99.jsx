...
export default function Section99({ isActive }) {
    ...
    useEffect(() => {
        ...
        const timers = [
            ...
            setTimeout(() => setStep(3), 1105), // Row 1
            setTimeout(() => setStep(4), 1530), // Row 2
            setTimeout(() => setStep(5), 1955), // Row 3
            setTimeout(() => setStep(6), 2550)  // Bottom
        ];
        ...
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full max-w-[1100px] grid grid-cols-1 md:grid-cols-2 gap-5 mb-[30px] relative">
                    ...
                    {/* Row 1 */}
                    <div className={`col-span-1 bg-white border-4 border-[#1e3a8a] rounded-none py-5 px-6 flex flex-col text-left shadow-sm transition-all duration-[850ms] ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    {/* Row 2 */}
                    <div className={`col-span-1 bg-white border-4 border-[#1e3a8a] rounded-none py-5 px-6 flex flex-col text-left shadow-sm transition-all duration-[850ms] ${step >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        <div className="flex items-center gap-3 mb-2">
                    ...
                    {/* Row 3 */}
                    <div className={`col-span-1 bg-white border-4 border-[#1e3a8a] rounded-none py-5 px-6 flex flex-col text-left shadow-sm transition-all duration-[850ms] ${step >= 5 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        <div className="flex items-center gap-3 mb-2">
