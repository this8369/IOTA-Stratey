        ...
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full max-w-[1000px] my-[20px] flex flex-col items-center">
                    ...
                    {/* Tier 1: Prime Trophy */}
                    <div className={`w-[60%] lg:w-[45%] bg-[#1d1d1f] text-white py-4 px-6 border-b-[4px] border-white z-30 relative shadow-2xl transition-all duration-[850ms] ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8'}`}>
                    ...
                    {/* Tier 2: Average */}
                    <div className={`w-[80%] lg:w-[65%] bg-gray-400 text-white py-4 px-6 border-b-[4px] border-white z-20 relative shadow-lg -mt-2 transition-all duration-[850ms] delay-100 ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8'}`}>
                    ...
                    {/* Tier 3: Class B / Bear */}
                    <div className={`w-full lg:w-[85%] bg-gray-100 border-[4px] border-gray-300 text-gray-800 py-5 px-8 z-10 relative shadow-sm -mt-2 transition-all duration-[850ms] delay-[170ms] ${step >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8'}`}>
