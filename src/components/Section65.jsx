        ...
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="flex flex-col lg:flex-row w-full max-w-[1100px] mt-[60px] mb-[50px] gap-6 lg:gap-10">
                    {/* Left: Seoul Trophy */}
                    <div className={`flex-1 bg-white border-[6px] border-[#1d1d1f] p-10 flex flex-col justify-center items-center shadow-2xl relative transition-all duration-[850ms] ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                    ...
                    {/* Equal Sign */}
                    <div className={`hidden lg:flex items-center justify-center transition-all duration-[850ms] delay-[170ms] ${step >= 2 ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`}>
                        <div className="text-[60px] font-black text-gray-300">≒</div>
                    </div>

                    {/* Right: Tokyo Marunouchi */}
                    <div className={`flex-1 bg-[#1d1d1f] text-white border-[6px] border-[#1d1d1f] p-10 flex flex-col justify-center items-center shadow-2xl relative transition-all duration-[850ms] delay-[255ms] ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
