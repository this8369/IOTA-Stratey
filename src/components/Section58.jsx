...
export default function Section58({ isActive }) {
    ...
    useEffect(() => {
        ...
        const timers = [
            ...
            setTimeout(() => setStep(5), 1870),
            setTimeout(() => setStep(6), 2210),
            setTimeout(() => setStep(7), 2550),
        ];
        ...
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="relative w-full max-w-[1000px] mt-[60px] mb-[60px] h-[300px] flex items-end justify-between px-4 md:px-12 border-b-[4px] border-[#1d1d1f]">
                    ...
                    {/* Bar 1: 2024 */}
                    <div className={`relative flex flex-col justify-end items-center w-[12%] transition-all duration-[850ms] ease-out h-full ${step >= 2 ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    {/* Bar 2: 2040 */}
                    <div className={`relative flex flex-col justify-end items-center w-[12%] transition-all duration-[850ms] ease-out h-full ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    {/* Bar 3: 2050 */}
                    <div className={`relative flex flex-col justify-end items-center w-[12%] transition-all duration-[850ms] ease-out h-full ${step >= 4 ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    {/* Bar 4: 2060 */}
                    <div className={`relative flex flex-col justify-end items-center w-[12%] transition-all duration-[850ms] ease-out h-full ${step >= 5 ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    {/* Bar 5: 2100 */}
                    <div className={`relative flex flex-col justify-end items-center w-[12%] transition-all duration-[850ms] ease-out h-full ${step >= 6 ? 'opacity-100' : 'opacity-0'}`}>
                ...
                {/* Bottom Text */}
                <div className={`mt-[20px] max-w-[1100px] text-[16px] md:text-[20px] leading-[1.5] font-bold text-gray-700 break-keep text-center transition-all duration-[765ms] ease-out ${step >= 7 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
