...
export default function Section87({ isActive }) {
    ...
    useEffect(() => {
        ...
        const timers = [
            ...
            setTimeout(() => setStep(3), 1200), // Blackstone
            setTimeout(() => setStep(4), 1400), // Brookfield
            setTimeout(() => setStep(5), 1600), // PGIM
            setTimeout(() => setStep(6), 1800), // Hines
            setTimeout(() => setStep(7), 2400), // IGIS
            setTimeout(() => setStep(8), 3000)  // Bottom Text
        ];
    ...
    return (
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                    ...
                    <div className="flex flex-col gap-3 border-l-[3px] border-gray-300 pl-4 pt-0 pb-2">
                        ...
                        <div className="flex items-center w-full mt-2">
                            ...
                            <div className="w-[75%] flex items-center relative">
                                ...
                                <div className={`absolute top-0 left-0 w-[100%] h-full flex items-center pl-[18%] transition-opacity duration-1000 delay-[1200ms] ${step >= 7 ? 'opacity-100' : 'opacity-0'}`}>
                ...
                {/* Bottom Thesis Text */}
                <div className={`max-w-[1000px] bg-blue-50 border border-blue-100 p-6 rounded-xl shadow-sm transition-all duration-700 ${step >= 8 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
