    ...
    return (
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-10 lg:gap-[40px] items-center justify-center">
                ...
                <div className={`shrink-0 w-full max-w-[590px] bg-gray-50 rounded-none p-8 md:py-8 md:px-12 border-[6px] border-gray-200 transition-all duration-[1000ms] ease-out ${step >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
