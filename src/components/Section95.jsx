        ...
        <section className="section w-full h-full bg-[#fdfdfd] flex flex-col items-center justify-center relative px-6 md:px-16 overflow-hidden">
            <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center">
                ...
                <div className="w-full max-w-[1100px] flex flex-col md:flex-row gap-6 mb-10 relative items-stretch">
                    ...
                    <div className={`flex-1 flex flex-col justify-center gap-4 transition-all duration-1000 ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        {/* PAST */}
                        ...
                        {/* PRESENT/FUTURE */}
                        <div className="bg-[#1e3a8a] rounded-2xl p-8 text-center border-4 border-blue-900 shadow-xl relative overflow-hidden">
                    ...
                    {/* Right: Core Enablers */}
                    <div className={`flex-[1.2] flex flex-col justify-center gap-5 transition-all duration-1000 ${step >= 4 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
                        
                        {/* Tech-Ready Building */}
                        <div className="bg-white border-2 border-[#1e3a8a] rounded-2xl p-6 shadow-sm flex items-start gap-5">
                            ...
                            <div className="text-left">
                                ...
                                <h4 className="text-[#1d1d1f] font-extrabold text-[20px] mb-2 break-keep">
                                    {lang === 'kr' ? '팩토리얼 성수 (로봇·IoT 친화)' : 'Factorial Seongsu (Robot & IoT Friendly)'}
                                </h4>
                                <p className="text-gray-600 font-medium text-[15px] leading-snug break-keep">
                        ...
                        <div className="bg-white border-2 border-[#1e3a8a] rounded-2xl p-6 shadow-sm flex items-start gap-5">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-gray-600 font-medium text-[15px] leading-snug break-keep">
                                    {lang === 'kr' ? '삼일PwC와의 협업을 통해 자산을순순한 임대 공간이 아닌, 기업 성장을 돕는 핵심 운영 인프라 서비스로 재정의' : 'Redefining assets as core operational infrastructure services that aid corporate growth, via collaboration with Samil PwC.'}
                                </p>
                            </div>
                        </div>
                ...
                <div className={`w-full max-w-[1100px] bg-blue-50 border border-blue-100 p-6 rounded-xl shadow-sm transition-all duration-700 ${step >= 5 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    <p className="text-[17px] md:text-[20px] font-bold text-[#1e3a8a] break-keep leading-relaxed text-center">
                        {lang === 'kr' 
                            ? <>팩토리얼 빌더스는 하드웨어(테크 레디)와 소프트웨어(AaaS)를 결합하여,<br/>부동산을 기업에게 '서비스'로서 제공하는 진정한 공간 운영 OS 플랫폼입니다.</>
                            : <>Factorial Builders combines hardware (Tech-Ready) and software (AaaS)<br/>to provide real estate as a 'service' to corporations, functioning as a true spatial operating OS platform.</>
                        }
                    </p>
                </div>
