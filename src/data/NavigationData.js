export const menuDataEn = [
        ...
        chapters: [
            {
                ...
                items: [
                    ...
                    { label: "Significance of IOTA Seoul", id: "page-6" },
                    { label: "Four Core Pillars of Master Plan", id: "page-7" },
                    { label: "The Rhythm of the Times", id: "page-8" }
                ]
            }
        ] 
    },
    ...
    { 
        ...
        chapters: [
            ...
            },
            {
                ...
                id: "page-102",
                items: [
                    { label: "Acquisition Underwriting", id: "page-103" },
                    { label: "Asset Management", id: "page-104" },
    ...
    { 
        title: "Part 4. Role of IOTA Seoul", 
        id: "page-115", 
        chapters: [
            {
    ...
    { 
        ...
        chapters: [
            ...
            },
            {
                ...
                id: "page-128",
                items: [
                    { label: "근원적 자산 가치", id: "page-129" },
                    { label: "프라임 프리미엄과 엑시트 전략", id: "page-130" }
                ]
            },
            {
                ...
                id: "page-131",
                items: [
                    { label: "매크로 및 시장 리스크", id: "page-132" },
