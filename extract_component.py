...
# We will just write a new file: src/components/system/shared/VehicleDetailCard.jsx
# Since we need a robust one, let's use the one from SystemFund421.jsx but add any missing props.
...
os.makedirs('src/components/system/shared', exist_ok=True)
