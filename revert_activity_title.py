...
old_title = '<h2 className="text-[18px] font-bold text-white tracking-tight translate-y-[2px]">{workspaceLabel ? workspaceLabel.split(\'-\')[0].trim() : \'\'} 업무 이력</h2>'
...
if old_title in content:
    ...
    with open(path, 'w') as f:
        f.write(content)
    print("Activity log title text updated back to 전체 활동.")
else:
